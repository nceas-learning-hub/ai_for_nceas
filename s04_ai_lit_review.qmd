...
| **Limitations** | - No personal uploads  <br> - Limited customization | - Limited assistance with theoretical or non-empirical research | - Hallucination in "Ask PDF" part  <br> - Struggles with large PDFs | - No PDF uploads  <br> - Graphs can be cluttered | - No external literature search  <br> - Early stage beta |
:::
## How to use it?
