...
* Looking for a dataset to practice with? Try the [SBCLTER annual fish survey](https://pasta.lternet.edu/package/data/eml/knb-lter-sbc/17/40/a7899f2e57ea29a240be2c00cce7a0d4). For free version of the ChatGPT, try dataset that is smaller than 10 KB, such as [Subset version of the annual fish survey](https://sbclter.msi.ucsb.edu/external/Reef/Data/trial_data/Annual_survey_NAPL_only.csv).
